...
// 			simBackend := simulated.NewBackend(alloc)
...
// func NewTContract(t *testing.T, simBackend *simulated.Backend, abiFile string, address common.Address) tConctract {
// 	return tConctract{
// 		t:          t,
...
// 	blockNumber, err := c.simBackend.Client().BlockNumber(context.Background())
// 	simRes, err := c.simBackend.Client().CallContract(context.Background(), ethereum.CallMsg{
// 		From:     fromAddress,
// 		To:       &c.address,
